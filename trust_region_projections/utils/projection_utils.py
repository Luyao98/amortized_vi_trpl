...
def gaussian_kl(policy: ConditionalGaussianModel, p: Tuple[ch.Tensor, ch.Tensor],
...
def gaussian_frobenius(policy: ConditionalGaussianModel, p: Tuple[ch.Tensor, ch.Tensor], q: Tuple[ch.Tensor, ch.Tensor],
...
def gaussian_wasserstein_commutative(policy: ConditionalGaussianModel, p: Tuple[ch.Tensor, ch.Tensor],
...
def gaussian_wasserstein_non_commutative(policy: ConditionalGaussianModel, p: Tuple[ch.Tensor, ch.Tensor],
...
def constraint_values(proj_type, policy: ConditionalGaussianModel, p: Tuple[ch.Tensor, ch.Tensor],
