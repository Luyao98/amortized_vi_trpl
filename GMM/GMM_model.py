...
from Gaussian.Gaussian_model import GaussianNN, covariance, get_samples, log_prob
...
if __name__ == "__main__":
    ...
    # for loss 1/2
    # plot2d_matplotlib(target, model, contexts, min_x=-50, max_x=50, min_y=-50, max_y=50)
