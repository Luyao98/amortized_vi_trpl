...
from toy_task.GMM.algorithms.algorithm_vanilla import toy_task_vanilla
from toy_task.GMM.utils.network_utils import set_seed


@hydra.main(version_base=None, config_path="../toy_task/GMM/conf", config_name="config_star_vanilla")
